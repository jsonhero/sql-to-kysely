...
class PostgreSQLLexer extends PostgreSQLLexerBase {
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    Operator_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 0:
    ...
    NumericFail_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 2:
    ...
    UnterminatedBlockComment_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 3:
    ...
    Operator_sempred(_localctx, predIndex) {
        switch (predIndex) {
            case 0:
                return this.checkLA('-');
            case 1:
    ...
    OperatorEndingWithPlusMinus_sempred(_localctx, predIndex) {
        switch (predIndex) {
            case 3:
                return this.checkLA('-');
            case 4:
...
PostgreSQLLexer.ALL = 30;
PostgreSQLLexer.ANALYSE = 31;
PostgreSQLLexer.ANALYZE = 32;
PostgreSQLLexer.AND = 33;
PostgreSQLLexer.ANY = 34;
PostgreSQLLexer.ARRAY = 35;
PostgreSQLLexer.AS = 36;
PostgreSQLLexer.ASC = 37;
PostgreSQLLexer.ASYMMETRIC = 38;
PostgreSQLLexer.BOTH = 39;
PostgreSQLLexer.CASE = 40;
PostgreSQLLexer.CAST = 41;
PostgreSQLLexer.CHECK = 42;
PostgreSQLLexer.COLLATE = 43;
PostgreSQLLexer.COLUMN = 44;
PostgreSQLLexer.CONSTRAINT = 45;
PostgreSQLLexer.CREATE = 46;
PostgreSQLLexer.CURRENT_CATALOG = 47;
PostgreSQLLexer.CURRENT_DATE = 48;
PostgreSQLLexer.CURRENT_ROLE = 49;
PostgreSQLLexer.CURRENT_TIME = 50;
PostgreSQLLexer.CURRENT_TIMESTAMP = 51;
PostgreSQLLexer.CURRENT_USER = 52;
PostgreSQLLexer.DEFAULT = 53;
PostgreSQLLexer.DEFERRABLE = 54;
PostgreSQLLexer.DESC = 55;
PostgreSQLLexer.DISTINCT = 56;
PostgreSQLLexer.DO = 57;
PostgreSQLLexer.ELSE = 58;
PostgreSQLLexer.EXCEPT = 59;
PostgreSQLLexer.FALSE_P = 60;
PostgreSQLLexer.FETCH = 61;
PostgreSQLLexer.FOR = 62;
PostgreSQLLexer.FOREIGN = 63;
PostgreSQLLexer.FROM = 64;
PostgreSQLLexer.GRANT = 65;
PostgreSQLLexer.GROUP_P = 66;
PostgreSQLLexer.HAVING = 67;
PostgreSQLLexer.IN_P = 68;
PostgreSQLLexer.INITIALLY = 69;
PostgreSQLLexer.INTERSECT = 70;
PostgreSQLLexer.INTO = 71;
PostgreSQLLexer.LATERAL_P = 72;
PostgreSQLLexer.LEADING = 73;
PostgreSQLLexer.LIMIT = 74;
PostgreSQLLexer.LOCALTIME = 75;
PostgreSQLLexer.LOCALTIMESTAMP = 76;
PostgreSQLLexer.NOT = 77;
PostgreSQLLexer.NULL_P = 78;
PostgreSQLLexer.OFFSET = 79;
PostgreSQLLexer.ON = 80;
PostgreSQLLexer.ONLY = 81;
PostgreSQLLexer.OR = 82;
PostgreSQLLexer.ORDER = 83;
PostgreSQLLexer.PLACING = 84;
PostgreSQLLexer.PRIMARY = 85;
PostgreSQLLexer.REFERENCES = 86;
PostgreSQLLexer.RETURNING = 87;
PostgreSQLLexer.SELECT = 88;
PostgreSQLLexer.SESSION_USER = 89;
PostgreSQLLexer.SOME = 90;
PostgreSQLLexer.SYMMETRIC = 91;
PostgreSQLLexer.TABLE = 92;
PostgreSQLLexer.THEN = 93;
PostgreSQLLexer.TO = 94;
PostgreSQLLexer.TRAILING = 95;
PostgreSQLLexer.TRUE_P = 96;
PostgreSQLLexer.UNION = 97;
PostgreSQLLexer.UNIQUE = 98;
PostgreSQLLexer.USER = 99;
PostgreSQLLexer.USING = 100;
PostgreSQLLexer.VARIADIC = 101;
PostgreSQLLexer.WHEN = 102;
PostgreSQLLexer.WHERE = 103;
PostgreSQLLexer.WINDOW = 104;
PostgreSQLLexer.WITH = 105;
PostgreSQLLexer.AUTHORIZATION = 106;
PostgreSQLLexer.BINARY = 107;
PostgreSQLLexer.COLLATION = 108;
PostgreSQLLexer.CONCURRENTLY = 109;
PostgreSQLLexer.CROSS = 110;
PostgreSQLLexer.CURRENT_SCHEMA = 111;
PostgreSQLLexer.FREEZE = 112;
PostgreSQLLexer.FULL = 113;
PostgreSQLLexer.ILIKE = 114;
PostgreSQLLexer.INNER_P = 115;
PostgreSQLLexer.IS = 116;
PostgreSQLLexer.ISNULL = 117;
PostgreSQLLexer.JOIN = 118;
PostgreSQLLexer.LEFT = 119;
PostgreSQLLexer.LIKE = 120;
PostgreSQLLexer.NATURAL = 121;
PostgreSQLLexer.NOTNULL = 122;
PostgreSQLLexer.OUTER_P = 123;
PostgreSQLLexer.OVER = 124;
PostgreSQLLexer.OVERLAPS = 125;
PostgreSQLLexer.RIGHT = 126;
PostgreSQLLexer.SIMILAR = 127;
PostgreSQLLexer.VERBOSE = 128;
PostgreSQLLexer.ABORT_P = 129;
PostgreSQLLexer.ABSOLUTE_P = 130;
PostgreSQLLexer.ACCESS = 131;
PostgreSQLLexer.ACTION = 132;
PostgreSQLLexer.ADD_P = 133;
PostgreSQLLexer.ADMIN = 134;
PostgreSQLLexer.AFTER = 135;
PostgreSQLLexer.AGGREGATE = 136;
PostgreSQLLexer.ALSO = 137;
PostgreSQLLexer.ALTER = 138;
PostgreSQLLexer.ALWAYS = 139;
PostgreSQLLexer.ASSERTION = 140;
PostgreSQLLexer.ASSIGNMENT = 141;
PostgreSQLLexer.AT = 142;
PostgreSQLLexer.ATTRIBUTE = 143;
PostgreSQLLexer.BACKWARD = 144;
PostgreSQLLexer.BEFORE = 145;
PostgreSQLLexer.BEGIN_P = 146;
PostgreSQLLexer.BY = 147;
PostgreSQLLexer.CACHE = 148;
PostgreSQLLexer.CALLED = 149;
PostgreSQLLexer.CASCADE = 150;
PostgreSQLLexer.CASCADED = 151;
PostgreSQLLexer.CATALOG = 152;
PostgreSQLLexer.CHAIN = 153;
PostgreSQLLexer.CHARACTERISTICS = 154;
PostgreSQLLexer.CHECKPOINT = 155;
PostgreSQLLexer.CLASS = 156;
PostgreSQLLexer.CLOSE = 157;
PostgreSQLLexer.CLUSTER = 158;
PostgreSQLLexer.COMMENT = 159;
PostgreSQLLexer.COMMENTS = 160;
PostgreSQLLexer.COMMIT = 161;
PostgreSQLLexer.COMMITTED = 162;
PostgreSQLLexer.CONFIGURATION = 163;
PostgreSQLLexer.CONNECTION = 164;
PostgreSQLLexer.CONSTRAINTS = 165;
PostgreSQLLexer.CONTENT_P = 166;
PostgreSQLLexer.CONTINUE_P = 167;
PostgreSQLLexer.CONVERSION_P = 168;
PostgreSQLLexer.COPY = 169;
PostgreSQLLexer.COST = 170;
PostgreSQLLexer.CSV = 171;
PostgreSQLLexer.CURSOR = 172;
PostgreSQLLexer.CYCLE = 173;
PostgreSQLLexer.DATA_P = 174;
PostgreSQLLexer.DATABASE = 175;
PostgreSQLLexer.DAY_P = 176;
PostgreSQLLexer.DEALLOCATE = 177;
PostgreSQLLexer.DECLARE = 178;
PostgreSQLLexer.DEFAULTS = 179;
PostgreSQLLexer.DEFERRED = 180;
PostgreSQLLexer.DEFINER = 181;
PostgreSQLLexer.DELETE_P = 182;
PostgreSQLLexer.DELIMITER = 183;
PostgreSQLLexer.DELIMITERS = 184;
PostgreSQLLexer.DICTIONARY = 185;
PostgreSQLLexer.DISABLE_P = 186;
PostgreSQLLexer.DISCARD = 187;
PostgreSQLLexer.DOCUMENT_P = 188;
PostgreSQLLexer.DOMAIN_P = 189;
PostgreSQLLexer.DOUBLE_P = 190;
PostgreSQLLexer.DROP = 191;
PostgreSQLLexer.EACH = 192;
PostgreSQLLexer.ENABLE_P = 193;
PostgreSQLLexer.ENCODING = 194;
PostgreSQLLexer.ENCRYPTED = 195;
PostgreSQLLexer.ENUM_P = 196;
PostgreSQLLexer.ESCAPE = 197;
PostgreSQLLexer.EVENT = 198;
PostgreSQLLexer.EXCLUDE = 199;
PostgreSQLLexer.EXCLUDING = 200;
PostgreSQLLexer.EXCLUSIVE = 201;
PostgreSQLLexer.EXECUTE = 202;
PostgreSQLLexer.EXPLAIN = 203;
PostgreSQLLexer.EXTENSION = 204;
PostgreSQLLexer.EXTERNAL = 205;
PostgreSQLLexer.FAMILY = 206;
PostgreSQLLexer.FIRST_P = 207;
PostgreSQLLexer.FOLLOWING = 208;
PostgreSQLLexer.FORCE = 209;
PostgreSQLLexer.FORWARD = 210;
PostgreSQLLexer.FUNCTION = 211;
PostgreSQLLexer.FUNCTIONS = 212;
PostgreSQLLexer.GLOBAL = 213;
PostgreSQLLexer.GRANTED = 214;
PostgreSQLLexer.HANDLER = 215;
PostgreSQLLexer.HEADER_P = 216;
PostgreSQLLexer.HOLD = 217;
PostgreSQLLexer.HOUR_P = 218;
PostgreSQLLexer.IDENTITY_P = 219;
PostgreSQLLexer.IF_P = 220;
PostgreSQLLexer.IMMEDIATE = 221;
PostgreSQLLexer.IMMUTABLE = 222;
PostgreSQLLexer.IMPLICIT_P = 223;
PostgreSQLLexer.INCLUDING = 224;
PostgreSQLLexer.INCREMENT = 225;
PostgreSQLLexer.INDEX = 226;
PostgreSQLLexer.INDEXES = 227;
PostgreSQLLexer.INHERIT = 228;
PostgreSQLLexer.INHERITS = 229;
PostgreSQLLexer.INLINE_P = 230;
PostgreSQLLexer.INSENSITIVE = 231;
PostgreSQLLexer.INSERT = 232;
PostgreSQLLexer.INSTEAD = 233;
PostgreSQLLexer.INVOKER = 234;
PostgreSQLLexer.ISOLATION = 235;
PostgreSQLLexer.KEY = 236;
PostgreSQLLexer.LABEL = 237;
PostgreSQLLexer.LANGUAGE = 238;
PostgreSQLLexer.LARGE_P = 239;
PostgreSQLLexer.LAST_P = 240;
PostgreSQLLexer.LEAKPROOF = 241;
PostgreSQLLexer.LEVEL = 242;
PostgreSQLLexer.LISTEN = 243;
PostgreSQLLexer.LOAD = 244;
PostgreSQLLexer.LOCAL = 245;
PostgreSQLLexer.LOCATION = 246;
PostgreSQLLexer.LOCK_P = 247;
PostgreSQLLexer.MAPPING = 248;
PostgreSQLLexer.MATCH = 249;
PostgreSQLLexer.MATERIALIZED = 250;
PostgreSQLLexer.MAXVALUE = 251;
PostgreSQLLexer.MINUTE_P = 252;
PostgreSQLLexer.MINVALUE = 253;
PostgreSQLLexer.MODE = 254;
PostgreSQLLexer.MONTH_P = 255;
PostgreSQLLexer.MOVE = 256;
PostgreSQLLexer.NAME_P = 257;
PostgreSQLLexer.NAMES = 258;
PostgreSQLLexer.NEXT = 259;
PostgreSQLLexer.NO = 260;
PostgreSQLLexer.NOTHING = 261;
PostgreSQLLexer.NOTIFY = 262;
PostgreSQLLexer.NOWAIT = 263;
PostgreSQLLexer.NULLS_P = 264;
PostgreSQLLexer.OBJECT_P = 265;
PostgreSQLLexer.OF = 266;
PostgreSQLLexer.OFF = 267;
PostgreSQLLexer.OIDS = 268;
PostgreSQLLexer.OPERATOR = 269;
PostgreSQLLexer.OPTION = 270;
PostgreSQLLexer.OPTIONS = 271;
PostgreSQLLexer.OWNED = 272;
PostgreSQLLexer.OWNER = 273;
PostgreSQLLexer.PARSER = 274;
PostgreSQLLexer.PARTIAL = 275;
PostgreSQLLexer.PARTITION = 276;
PostgreSQLLexer.PASSING = 277;
PostgreSQLLexer.PASSWORD = 278;
PostgreSQLLexer.PLANS = 279;
PostgreSQLLexer.PRECEDING = 280;
PostgreSQLLexer.PREPARE = 281;
PostgreSQLLexer.PREPARED = 282;
PostgreSQLLexer.PRESERVE = 283;
PostgreSQLLexer.PRIOR = 284;
PostgreSQLLexer.PRIVILEGES = 285;
PostgreSQLLexer.PROCEDURAL = 286;
PostgreSQLLexer.PROCEDURE = 287;
PostgreSQLLexer.PROGRAM = 288;
PostgreSQLLexer.QUOTE = 289;
PostgreSQLLexer.RANGE = 290;
PostgreSQLLexer.READ = 291;
PostgreSQLLexer.REASSIGN = 292;
PostgreSQLLexer.RECHECK = 293;
PostgreSQLLexer.RECURSIVE = 294;
PostgreSQLLexer.REF = 295;
PostgreSQLLexer.REFRESH = 296;
PostgreSQLLexer.REINDEX = 297;
PostgreSQLLexer.RELATIVE_P = 298;
PostgreSQLLexer.RELEASE = 299;
PostgreSQLLexer.RENAME = 300;
PostgreSQLLexer.REPEATABLE = 301;
PostgreSQLLexer.REPLACE = 302;
PostgreSQLLexer.REPLICA = 303;
PostgreSQLLexer.RESET = 304;
PostgreSQLLexer.RESTART = 305;
PostgreSQLLexer.RESTRICT = 306;
PostgreSQLLexer.RETURNS = 307;
PostgreSQLLexer.REVOKE = 308;
PostgreSQLLexer.ROLE = 309;
PostgreSQLLexer.ROLLBACK = 310;
PostgreSQLLexer.ROWS = 311;
PostgreSQLLexer.RULE = 312;
PostgreSQLLexer.SAVEPOINT = 313;
PostgreSQLLexer.SCHEMA = 314;
PostgreSQLLexer.SCROLL = 315;
PostgreSQLLexer.SEARCH = 316;
PostgreSQLLexer.SECOND_P = 317;
PostgreSQLLexer.SECURITY = 318;
PostgreSQLLexer.SEQUENCE = 319;
PostgreSQLLexer.SEQUENCES = 320;
PostgreSQLLexer.SERIALIZABLE = 321;
PostgreSQLLexer.SERVER = 322;
PostgreSQLLexer.SESSION = 323;
PostgreSQLLexer.SET = 324;
PostgreSQLLexer.SHARE = 325;
PostgreSQLLexer.SHOW = 326;
PostgreSQLLexer.SIMPLE = 327;
PostgreSQLLexer.SNAPSHOT = 328;
PostgreSQLLexer.STABLE = 329;
PostgreSQLLexer.STANDALONE_P = 330;
PostgreSQLLexer.START = 331;
PostgreSQLLexer.STATEMENT = 332;
PostgreSQLLexer.STATISTICS = 333;
PostgreSQLLexer.STDIN = 334;
PostgreSQLLexer.STDOUT = 335;
PostgreSQLLexer.STORAGE = 336;
PostgreSQLLexer.STRICT_P = 337;
PostgreSQLLexer.STRIP_P = 338;
PostgreSQLLexer.SYSID = 339;
PostgreSQLLexer.SYSTEM_P = 340;
PostgreSQLLexer.TABLES = 341;
PostgreSQLLexer.TABLESPACE = 342;
PostgreSQLLexer.TEMP = 343;
PostgreSQLLexer.TEMPLATE = 344;
PostgreSQLLexer.TEMPORARY = 345;
PostgreSQLLexer.TEXT_P = 346;
PostgreSQLLexer.TRANSACTION = 347;
PostgreSQLLexer.TRIGGER = 348;
PostgreSQLLexer.TRUNCATE = 349;
PostgreSQLLexer.TRUSTED = 350;
PostgreSQLLexer.TYPE_P = 351;
PostgreSQLLexer.TYPES_P = 352;
PostgreSQLLexer.UNBOUNDED = 353;
PostgreSQLLexer.UNCOMMITTED = 354;
PostgreSQLLexer.UNENCRYPTED = 355;
PostgreSQLLexer.UNKNOWN = 356;
PostgreSQLLexer.UNLISTEN = 357;
PostgreSQLLexer.UNLOGGED = 358;
PostgreSQLLexer.UNTIL = 359;
PostgreSQLLexer.UPDATE = 360;
PostgreSQLLexer.VACUUM = 361;
PostgreSQLLexer.VALID = 362;
PostgreSQLLexer.VALIDATE = 363;
PostgreSQLLexer.VALIDATOR = 364;
PostgreSQLLexer.VARYING = 365;
PostgreSQLLexer.VERSION_P = 366;
PostgreSQLLexer.VIEW = 367;
PostgreSQLLexer.VOLATILE = 368;
PostgreSQLLexer.WHITESPACE_P = 369;
PostgreSQLLexer.WITHOUT = 370;
PostgreSQLLexer.WORK = 371;
PostgreSQLLexer.WRAPPER = 372;
PostgreSQLLexer.WRITE = 373;
PostgreSQLLexer.XML_P = 374;
PostgreSQLLexer.YEAR_P = 375;
PostgreSQLLexer.YES_P = 376;
PostgreSQLLexer.ZONE = 377;
PostgreSQLLexer.BETWEEN = 378;
PostgreSQLLexer.BIGINT = 379;
PostgreSQLLexer.BIT = 380;
PostgreSQLLexer.BOOLEAN_P = 381;
PostgreSQLLexer.CHAR_P = 382;
PostgreSQLLexer.CHARACTER = 383;
PostgreSQLLexer.COALESCE = 384;
PostgreSQLLexer.DEC = 385;
PostgreSQLLexer.DECIMAL_P = 386;
PostgreSQLLexer.EXISTS = 387;
PostgreSQLLexer.EXTRACT = 388;
PostgreSQLLexer.FLOAT_P = 389;
PostgreSQLLexer.GREATEST = 390;
PostgreSQLLexer.INOUT = 391;
PostgreSQLLexer.INT_P = 392;
PostgreSQLLexer.INTEGER = 393;
PostgreSQLLexer.INTERVAL = 394;
PostgreSQLLexer.LEAST = 395;
PostgreSQLLexer.NATIONAL = 396;
PostgreSQLLexer.NCHAR = 397;
PostgreSQLLexer.NONE = 398;
PostgreSQLLexer.NULLIF = 399;
PostgreSQLLexer.NUMERIC = 400;
PostgreSQLLexer.OVERLAY = 401;
PostgreSQLLexer.POSITION = 402;
PostgreSQLLexer.PRECISION = 403;
PostgreSQLLexer.REAL = 404;
PostgreSQLLexer.ROW = 405;
PostgreSQLLexer.SETOF = 406;
PostgreSQLLexer.SMALLINT = 407;
PostgreSQLLexer.SUBSTRING = 408;
PostgreSQLLexer.TIME = 409;
PostgreSQLLexer.TIMESTAMP = 410;
PostgreSQLLexer.TREAT = 411;
PostgreSQLLexer.TRIM = 412;
PostgreSQLLexer.VALUES = 413;
PostgreSQLLexer.VARCHAR = 414;
PostgreSQLLexer.XMLATTRIBUTES = 415;
PostgreSQLLexer.XMLCONCAT = 416;
PostgreSQLLexer.XMLELEMENT = 417;
PostgreSQLLexer.XMLEXISTS = 418;
PostgreSQLLexer.XMLFOREST = 419;
PostgreSQLLexer.XMLPARSE = 420;
PostgreSQLLexer.XMLPI = 421;
PostgreSQLLexer.XMLROOT = 422;
PostgreSQLLexer.XMLSERIALIZE = 423;
PostgreSQLLexer.CALL = 424;
PostgreSQLLexer.CURRENT_P = 425;
PostgreSQLLexer.ATTACH = 426;
PostgreSQLLexer.DETACH = 427;
PostgreSQLLexer.EXPRESSION = 428;
PostgreSQLLexer.GENERATED = 429;
PostgreSQLLexer.LOGGED = 430;
PostgreSQLLexer.STORED = 431;
PostgreSQLLexer.INCLUDE = 432;
PostgreSQLLexer.ROUTINE = 433;
PostgreSQLLexer.TRANSFORM = 434;
PostgreSQLLexer.IMPORT_P = 435;
PostgreSQLLexer.POLICY = 436;
PostgreSQLLexer.METHOD = 437;
PostgreSQLLexer.REFERENCING = 438;
PostgreSQLLexer.NEW = 439;
PostgreSQLLexer.OLD = 440;
PostgreSQLLexer.VALUE_P = 441;
PostgreSQLLexer.SUBSCRIPTION = 442;
PostgreSQLLexer.PUBLICATION = 443;
PostgreSQLLexer.OUT_P = 444;
PostgreSQLLexer.END_P = 445;
PostgreSQLLexer.ROUTINES = 446;
PostgreSQLLexer.SCHEMAS = 447;
PostgreSQLLexer.PROCEDURES = 448;
PostgreSQLLexer.INPUT_P = 449;
PostgreSQLLexer.SUPPORT = 450;
PostgreSQLLexer.PARALLEL = 451;
PostgreSQLLexer.SQL_P = 452;
PostgreSQLLexer.DEPENDS = 453;
PostgreSQLLexer.OVERRIDING = 454;
PostgreSQLLexer.CONFLICT = 455;
PostgreSQLLexer.SKIP_P = 456;
PostgreSQLLexer.LOCKED = 457;
PostgreSQLLexer.TIES = 458;
PostgreSQLLexer.ROLLUP = 459;
PostgreSQLLexer.CUBE = 460;
PostgreSQLLexer.GROUPING = 461;
PostgreSQLLexer.SETS = 462;
PostgreSQLLexer.TABLESAMPLE = 463;
PostgreSQLLexer.ORDINALITY = 464;
PostgreSQLLexer.XMLTABLE = 465;
PostgreSQLLexer.COLUMNS = 466;
PostgreSQLLexer.XMLNAMESPACES = 467;
PostgreSQLLexer.ROWTYPE = 468;
PostgreSQLLexer.NORMALIZED = 469;
PostgreSQLLexer.WITHIN = 470;
PostgreSQLLexer.FILTER = 471;
PostgreSQLLexer.GROUPS = 472;
PostgreSQLLexer.OTHERS = 473;
PostgreSQLLexer.NFC = 474;
PostgreSQLLexer.NFD = 475;
PostgreSQLLexer.NFKC = 476;
PostgreSQLLexer.NFKD = 477;
PostgreSQLLexer.UESCAPE = 478;
PostgreSQLLexer.VIEWS = 479;
PostgreSQLLexer.NORMALIZE = 480;
PostgreSQLLexer.DUMP = 481;
PostgreSQLLexer.PRINT_STRICT_PARAMS = 482;
PostgreSQLLexer.VARIABLE_CONFLICT = 483;
PostgreSQLLexer.ERROR = 484;
PostgreSQLLexer.USE_VARIABLE = 485;
PostgreSQLLexer.USE_COLUMN = 486;
PostgreSQLLexer.ALIAS = 487;
PostgreSQLLexer.CONSTANT = 488;
PostgreSQLLexer.PERFORM = 489;
PostgreSQLLexer.GET = 490;
PostgreSQLLexer.DIAGNOSTICS = 491;
PostgreSQLLexer.STACKED = 492;
PostgreSQLLexer.ELSIF = 493;
PostgreSQLLexer.WHILE = 494;
PostgreSQLLexer.REVERSE = 495;
PostgreSQLLexer.FOREACH = 496;
PostgreSQLLexer.SLICE = 497;
PostgreSQLLexer.EXIT = 498;
PostgreSQLLexer.RETURN = 499;
PostgreSQLLexer.QUERY = 500;
PostgreSQLLexer.RAISE = 501;
PostgreSQLLexer.SQLSTATE = 502;
PostgreSQLLexer.DEBUG = 503;
PostgreSQLLexer.LOG = 504;
PostgreSQLLexer.INFO = 505;
PostgreSQLLexer.NOTICE = 506;
PostgreSQLLexer.WARNING = 507;
PostgreSQLLexer.EXCEPTION = 508;
PostgreSQLLexer.ASSERT = 509;
PostgreSQLLexer.LOOP = 510;
PostgreSQLLexer.OPEN = 511;
PostgreSQLLexer.Identifier = 512;
PostgreSQLLexer.QuotedIdentifier = 513;
PostgreSQLLexer.UnterminatedQuotedIdentifier = 514;
PostgreSQLLexer.InvalidQuotedIdentifier = 515;
PostgreSQLLexer.InvalidUnterminatedQuotedIdentifier = 516;
PostgreSQLLexer.UnicodeQuotedIdentifier = 517;
PostgreSQLLexer.UnterminatedUnicodeQuotedIdentifier = 518;
PostgreSQLLexer.InvalidUnicodeQuotedIdentifier = 519;
PostgreSQLLexer.InvalidUnterminatedUnicodeQuotedIdentifier = 520;
PostgreSQLLexer.StringConstant = 521;
PostgreSQLLexer.UnterminatedStringConstant = 522;
PostgreSQLLexer.UnicodeEscapeStringConstant = 523;
PostgreSQLLexer.UnterminatedUnicodeEscapeStringConstant = 524;
PostgreSQLLexer.BeginDollarStringConstant = 525;
PostgreSQLLexer.BinaryStringConstant = 526;
PostgreSQLLexer.UnterminatedBinaryStringConstant = 527;
PostgreSQLLexer.InvalidBinaryStringConstant = 528;
PostgreSQLLexer.InvalidUnterminatedBinaryStringConstant = 529;
PostgreSQLLexer.HexadecimalStringConstant = 530;
PostgreSQLLexer.UnterminatedHexadecimalStringConstant = 531;
PostgreSQLLexer.InvalidHexadecimalStringConstant = 532;
PostgreSQLLexer.InvalidUnterminatedHexadecimalStringConstant = 533;
PostgreSQLLexer.Integral = 534;
PostgreSQLLexer.NumericFail = 535;
PostgreSQLLexer.Numeric = 536;
PostgreSQLLexer.PLSQLVARIABLENAME = 537;
PostgreSQLLexer.PLSQLIDENTIFIER = 538;
PostgreSQLLexer.Whitespace = 539;
PostgreSQLLexer.Newline = 540;
PostgreSQLLexer.LineComment = 541;
PostgreSQLLexer.BlockComment = 542;
PostgreSQLLexer.UnterminatedBlockComment = 543;
PostgreSQLLexer.MetaCommand = 544;
PostgreSQLLexer.EndMetaCommand = 545;
PostgreSQLLexer.ErrorCharacter = 546;
PostgreSQLLexer.EscapeStringConstant = 547;
PostgreSQLLexer.UnterminatedEscapeStringConstant = 548;
PostgreSQLLexer.InvalidEscapeStringConstant = 549;
PostgreSQLLexer.InvalidUnterminatedEscapeStringConstant = 550;
PostgreSQLLexer.DollarText = 551;
PostgreSQLLexer.EndDollarStringConstant = 552;
PostgreSQLLexer.AfterEscapeStringConstantWithNewlineMode_Continued = 553;
...
PostgreSQLLexer._LITERAL_NAMES = [
    undefined, "'$'", "'('", "')'", "'['", "']'", "','", "';'", "':'", "'*'",
    "'='", "'.'", "'+'", "'-'", "'/'", "'^'", "'<'", "'>'", "'<<'", "'>>'",
    "':='", "'<='", "'=>'", "'>='", "'..'", "'<>'", "'::'", "'%'", undefined,
...
PostgreSQLLexer._SYMBOLIC_NAMES = [
...
PostgreSQLLexer.VOCABULARY = new VocabularyImpl(PostgreSQLLexer._LITERAL_NAMES, PostgreSQLLexer._SYMBOLIC_NAMES, []);
PostgreSQLLexer._serializedATNSegments = 10;
PostgreSQLLexer._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\u022B\u1510\b" +
...
PostgreSQLLexer._serializedATNSegment1 = "\xC5\x03\xC5\x03\xC6\x03\xC6\x03\xC6\x03\xC6\x03\xC6\x03\xC6\x03\xC6\x03" +
    ...
    "\x03\u020E\x03\u020E";
PostgreSQLLexer._serializedATNSegment2 = "\x03\u020E\x03\u020F\x03\u020F\x03\u020F\x03\u020F\x03\u0210\x03\u0210" +
    ...
    "\x02\x02\x02\x02\u02E9";
PostgreSQLLexer._serializedATNSegment3 = "\x03\x02\x02\x02\x02\u02EB\x03\x02\x02\x02\x02\u02ED\x03\x02\x02\x02\x02" +
    ...
    "\x05C \x02\u04BF\u04C3\x07-";
PostgreSQLLexer._serializedATNSegment4 = "\x02\x02\u04C0\u04C1\x07/\x02\x02\u04C1\u04C3\x06\x1E\x02\x02\u04C2\u04BF" +
...
PostgreSQLLexer._serializedATNSegment5 = "\u07F4\u07F5\x07C\x02\x02\u07F5\u07F6\x07I\x02\x02\u07F6\u07F7\x07I\x02" +
...
PostgreSQLLexer._serializedATNSegment6 = "\x07G\x02\x02\u0B36\u0B37\x07C\x02\x02\u0B37\u0B38\x07M\x02\x02\u0B38" +
    ...
    "\x07R\x02\x02\u0E76\u0E77\x07G";
PostgreSQLLexer._serializedATNSegment7 = "\x02\x02\u0E77\u0E78\x07U\x02\x02\u0E78\u02CE\x03\x02\x02\x02\u0E79\u0E7A" +
    ...
    "\x02";
PostgreSQLLexer._serializedATNSegment8 = "\u11B8\u11B9\x07P\x02\x02\u11B9\u11BA\x07I\x02\x02\u11BA\u03A8\x03\x02" +
    ...
    "\u14C1";
PostgreSQLLexer._serializedATNSegment9 = "\t\x0F\x02\x02\u14BF\u14C1\n\x18\x02\x02\u14C0\u14AF\x03\x02\x02\x02\u14C0" +
    ...
    "\x06\x06\x02\x02";
PostgreSQLLexer._serializedATN = Utils.join([
...
//# sourceMappingURL=PostgreSQLLexer.js.map